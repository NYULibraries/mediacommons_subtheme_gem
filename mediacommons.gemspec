...
require './lib/mediacommons'

Gem::Specification.new do |s|
  # Release Specific Information
  #  Replace Extension with the name you used in your extension.rb
  #   in the mdodule with version and date.
  s.version = Mediacommons::VERSION
  s.date = Mediacommons::DATE

  # Gem Details
  s.name = "mediacommons"
  s.rubyforge_project = "mediacommons"
  ...
  s.authors = ["Mark Reilly, Laura Henze"]
  # The email address(es) of the author(s)
  # If more than one author, comma separate inside of the brackets
  s.email = ["mark.reilly@nyu.edu", "laura.henze@nyu.edu"]
  # URL of the extension
  s.homepage = "http://mediacommons.futureofthebook.org/"
